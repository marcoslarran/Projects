...
map_rest1 = pd.read_parquet('https://storage.googleapis.com/restaurants_datalake/restaurants.parquet')
...
# -------Filtro del DF--------
if slide_tipo == "Todos":
    st.warning('Por favor seleccione un tipo de comida específico', icon="ℹ️")
else: 
    ...
    # Gráfico del filtro de fecha
        filtro_fecha = st.slider("Seleccione periodo a revisar", value=(datetime(fecha1.year, fecha1.month,fecha1.day),datetime(fecha2.year, fecha2.month,fecha2.day)))
        ...
        agregar_a_sw = ['good','bad','awesome','awfull','love','like','well','ok','get','back','never','one','two','three','amazing'
                'four','five','go','would','got','said','us','came','ask','told','went','better','worst','great','best','horrible',"nan"]
